...
import { AmazonPayCustomerInitializeOptions, BraintreeVisaCheckoutCustomerInitializeOptions, ChasePayCustomerInitializeOptions, SquareCustomerInitializeOptions } from './strategies';
...
export interface CustomerInitializeOptions extends CustomerRequestOptions {
    ...
    squarev2?: SquareCustomerInitializeOptions;
}
