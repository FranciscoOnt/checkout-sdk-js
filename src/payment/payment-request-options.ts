...
import { ZipInitializeOptions } from './strategies/zip';
...
export interface PaymentInitializeOptions extends PaymentRequestOptions {
    ...
    /**
     * The options that are required to initialize the Zip payment method.
     * They can be omitted unless you need to support Zip.
     */
    zip?: ZipInitializeOptions;
}
