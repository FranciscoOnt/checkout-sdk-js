...
import { createGooglePayPaymentProcessor, GooglePaymentData, GooglePayCheckoutcomInitializer, GooglePayPaymentProcessor } from '../../../payment/strategies/googlepay';
...
describe('GooglePayCheckoutButtonStrategy', () => {
    ...
    describe('#deinitialize()', () => {
        ...
        beforeEach(() => {
            checkoutButtonOptions = getCheckoutButtonOptions(Mode.GooglePayCheckoutcom);
        });
    ...
    describe('#handleWalletButtonClick', () => {
        ...
        beforeEach(() => {
            googlePayOptions = getCheckoutButtonOptions(Mode.GooglePayCheckoutcom);
